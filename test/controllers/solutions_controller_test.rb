...
class SolutionsControllerTest < ActionController::TestCase
  ...
  test "should create solution" do
    assert_difference('Solution.count') do
      post :create, solution: { correct: @solution.correct, participant_id: @solution.participant_id, question_id: @solution.question_id }
    end
  ...
  test "should update solution" do
    patch :update, id: @solution, solution: { correct: @solution.correct, participant_id: @solution.participant_id, question_id: @solution.question_id }
    assert_redirected_to solution_path(assigns(:solution))
  end
